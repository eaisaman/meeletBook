define(
    ...
    function () {
        return function (appModule, extension, opts) {
            var inject = ["$http", "$timeout", "$q", "$exceptionHandler", "$parse", "angularEventTypes", "utilService"];

            appModule.directive("uiModalWindow", _.union(inject, [function ($http, $timeout, $q, $exceptionHandler, $parse, angularEventTypes, utilService) {
                'use strict';
