  ...
  renderRow: function(rowData: string, sectionId: string, rowId: string): ReactElement {
    if (sectionId === "*") {
      switch(rowId) {
        case "btn_album":
          return (
          <TouchableOpacity style={[styles.row,]} onPress={() => { this.routeFunc('photoAlbum'); }}>
        ...
        case "btn_collection":
          return (
          <TouchableOpacity style={[styles.row,]} onPress={() => { this.routeFunc('favorites'); }}>
        ...
        case "btn_settings":
          return (
          <TouchableOpacity style={[styles.row,]} onPress={() => { this.routeFunc('settings'); }}>
